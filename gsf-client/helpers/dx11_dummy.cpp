...
bool helpers::dx11_dummy_device_dup(HWND target_window, ID3D11Device *&out_device_ptr, IDXGISwapChain *&out_swapchain_ptr)
{
    ...
    HRESULT hr = D3D11CreateDeviceAndSwapChain(nullptr, D3D_DRIVER_TYPE_REFERENCE, nullptr, 0, nullptr, 0, D3D11_SDK_VERSION, &scd, &out_swapchain_ptr, &out_device_ptr, &fl, nullptr);
