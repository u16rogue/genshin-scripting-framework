...
bool game::init()
{
	...
	||  !DEBUG_CON_C_LOG(L"gsf::hooks::WorldEntityIterator_get_speed_ptr",   hlp_aob_scan(mod_unity_player,  gsf::hooks::WorldEntityIterator_get_speed_ptr,   "\x41\x83\xBF\x00\x00\x00\x00\x00\x74\x21",                                     "xxx?????xx"))
	) {
		return false;
	}
