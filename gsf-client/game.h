...
namespace game
{
	...
	inline game::sdk::UnityEngine_Transform_get_position_t        UnityEngine_Transform_get_position        ("UnityEngine.Transform::INTERNAL_get_position(UnityEngine.Vector3&)");
