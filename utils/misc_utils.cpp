...
std::uint8_t *utils::calc_rel_address_32(void *instruction_address, std::size_t instruction_size, std::size_t instruction_operand_relative_offset)
{
	...
	std::uintptr_t next_instruction = reinterpret_cast<std::uintptr_t>(instruction_address) + instruction_size;
